...
- 💼 Full Stack Developer with experience in **Angular**, **.NET**, and **SQL**
- 🚀 Building robust web applications end-to-end (frontend + backend + database)
- 🎓 Currently in my 4th semester of **Systems Engineering** at **Corporación Universitaria del Huila - CORHUILA**
...
- 🎓 **Systems Engineering** (4th semester, in progress) — Corporación Universitaria del Huila (CORHUILA)
- 🎓 **Technologist in Information Systems Analysis and Development** — SENA
- 🎓 **Technician in Systems** — SENA
